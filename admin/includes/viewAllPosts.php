    ...
    foreach($_POST['checkBoxArray'] as $postValueId){
        ...
        switch($bulk_options){
            ...
            case 'clone':
                ...
                $query = "INSERT INTO posts(post_category_id, post_title, post_user, post_date, post_status, post_image, post_tags, post_content) ";
                $query .= "VALUES({$post_category_id}, '{$post_title}', '{$post_user}', '{$post_date}', '{$post_status}', '{$post_image}', '{$post_tags}', '{$post_content}') ";
...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        ...
        <div class="col-xs-4">
            <input type="submit" name="submit" class="btn btn-success" value="Apply"><a class="btn btn-primary" href="posts.php?source=addPost">Add New Post</a>
        </div>
